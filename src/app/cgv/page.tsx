  ...
  return (
    <LegalLayout title="Conditions Générales de Vente">
      ...
      <section className="mb-10">
        ...
        <p className="text-zinc-300 mb-4">Les prestations proposées comprennent notamment :</p>
      ...
      <section className="mb-10">
        ...
        <div className="border-l border-amber-500/40 pl-5 py-1 mb-4">
          <p className="text-zinc-300 mb-2">
            <span className="text-zinc-100 font-medium">TVA :</span> Non applicable (article 293 B du CGI)
          </p>
          <p className="text-zinc-300">
            <span className="text-zinc-100 font-medium">Modalités :</span> Définies dans chaque devis
          </p>
        </div>
        <p className="text-zinc-300 mb-4">
        ...
        <p className="text-zinc-300 mt-4">
          <span className="text-zinc-100 font-medium">Moyens de paiement acceptés :</span> Virement bancaire, PayPal
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-zinc-300">
          <span className="text-zinc-100 font-medium">Modifications post-livraison :</span> Toute modification 
      ...
      <section className="mb-10">
        ...
        <div className="border-l border-amber-500/40 pl-5 py-1">
          <p className="text-zinc-100 font-medium mb-2">Médiation de la consommation</p>
          <p className="text-zinc-300">
            ...
            <a href="https://ec.europa.eu/consumers/odr" className="text-amber-400 hover:text-amber-300 underline decoration-amber-400/40 underline-offset-2 ml-1" target="_blank" rel="noopener noreferrer">
      ...
      <section className="mb-10">
        ...
        <div className="border-l border-amber-500/40 pl-5 py-1 space-y-2">
          <p className="text-zinc-300"><span className="text-zinc-100 font-medium">Valentin MAROT</span></p>
