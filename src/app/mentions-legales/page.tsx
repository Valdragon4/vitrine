    ...
    <LegalLayout title="Mentions légales">
      <section className="mb-10">
        ...
        <div className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50 space-y-2">
          <p className="text-slate-300"><span className="text-slate-100 font-medium">Nom :</span> Valentin MAROT</p>
          <p className="text-slate-300"><span className="text-slate-100 font-medium">Statut :</span> Micro-entrepreneur</p>
          <p className="text-slate-300"><span className="text-slate-100 font-medium">SIRET :</span> 94108004600019</p>
          <p className="text-slate-300"><span className="text-slate-100 font-medium">Adresse :</span> Troyes, France</p>
      ...
      <section className="mb-10">
        ...
        <div className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50 space-y-2">
          <p className="text-slate-300"><span className="text-slate-100 font-medium">Hébergeur :</span> Auto-hébergement</p>
          <p className="text-slate-300"><span className="text-slate-100 font-medium">Responsable :</span> Valentin MAROT</p>
          <p className="text-slate-300"><span className="text-slate-100 font-medium">Localisation :</span> Troyes, France</p>
        </div>
      </section>
